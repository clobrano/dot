vim.api.nvim_set_keymap('n', '<leader>do', '<cmd>lua vim.diagnostic.open_float()<CR>',
  { desc = "Open Diagnostic Floating window", noremap = true, silent = true })
