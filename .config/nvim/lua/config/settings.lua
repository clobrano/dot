...
vim.opt.conceallevel = 3 -- conceal text hidden unless it has a custom replacement
vim.o.conceallevel = 3 -- conceal text hidden unless it has a custom replacement
