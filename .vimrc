...
source ~/.vim/clobrano/settings.vim
source ~/.vim/clobrano/mappings.vim
source ~/.vim/clobrano/autocommands.vim
source ~/.vim/clobrano/abbreviations.vim
source ~/.vim/clobrano/functions.vim
...
" editorconfig                       {{{
iabbr editorconfig <esc>:-1 r~/.vim/snippets/editorconfig/template.vim
"}}}
...
" Custom Snippets                    {{{
source ~/.vim/snippets/browser.config.vim
source ~/.vim/snippets/c_cpp.config.vim
source ~/.vim/snippets/canonical.config.vim
source ~/.vim/snippets/golang.vim
source ~/.vim/snippets/licenses.config.vim
source ~/.vim/snippets/python.config.vim
source ~/.vim/snippets/shell.config.vim
source ~/.vim/snippets/cisco.vim
"}}}
...
autocmd FileType markdown,txt source ~/.vim/snippets/markdown.vim
