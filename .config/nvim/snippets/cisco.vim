iabbr spackreq <esc>:-1r! sed -n 3,16p ~/.config/nvim/snippets/cisco.vim
" ---
...
"    buf_position += tlv_sz;
" ---
iabbr spackopt <esc>:-1r! sed -n 20,36p ~/.config/nvim/snippets/cisco.vim
" ---
...
"    }
" ---
iabbr sunpackreq <esc>:-1r! sed -n 40,47p ~/.config/nvim/snippets/cisco.vim
" ---
...
" ---
iabbr sunpackopt <esc>:-1r! sed -n 51,62p ~/.config/nvim/snippets/cisco.vim
" ---
...
"    }
" ---
iabbr sunpackstub <esc>:-1r! sed -n 66,85p ~/.config/nvim/snippets/cisco.vim
" ---
...
"}
"" ---
iabbr spackstub <esc>:-1r! sed -n 89,117p ~/.config/nvim/snippets/cisco.vim
" ---
...
"}
" ---
iabbr sgetstring <esc>:-1r! sed -n 121,126p ~/.config/nvim/snippets/cisco.vim
" ---
